...
zh:
  ...
  title: 第二十四集 做：步法
  content: |-
    「先看一步走，再聽一張口」，可見步法在某程度上決定一個演員的台風，步法即是台步，亦是粵劇表演中角色的腳步行動特徵和表現方法。

     

    身法與步法密不可分，所謂「身由步而動，步隨身而行」，而步法的一切都源自於腰部，所以腰部的運用對步法是非常重要。
...
cn:
  ...
  youtubeVideoID: jCRTm5zJngo
  content: |-
    「先看一步走，再听一张口」，可见步法在某程度上决定一个演员的台风，步法即是台步，亦是粤剧表演中角色的脚步行动特征和表现方法。

     

    身法与步法密不可分，所谓「身由步而动，步随身而行」，而步法的一切都源自于腰部，所以腰部的运用对步法是非常重要。
---
