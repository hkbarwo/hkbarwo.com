...
exports.createMemberMemorialPage = async ({ actions, graphql }, context) => {
  const { locale, defaultLocale, pages: { 'member-memorial': pageItem } } = context;
